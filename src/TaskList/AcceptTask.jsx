...
const AcceptTask = ({data}) => {
  return (
    <div className="shrink-0 h-[350px] w-[360px] bg-red-400 rounded-xl">
          ...
          <div className='mt-4 px-2 flex justify-evenly'>
            <button className='bg-green-500 px-2 py-1 rounded-lg '>Mark as Completed</button>
            <button className='bg-red-500 px-2 py-1 rounded-lg '>Mark as Failed</button>
          </div>
        </div>
  )
}
